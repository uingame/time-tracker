...
const rows = [
  ...
  createData(undefined , '14:00', '16:30', 1, 'בית ספר #2', 'פעילות #2'),
  createData(8, '12:00', '13:30', 3, 'בית ספר #1', 'פעילות #1', ''),
];
      ...
      <div>
        ...
        <FormControl className={classes.filter}>
          ...
          >
            ...
            <MenuItem value={10}>עובד #1</MenuItem>
            <MenuItem value={20}>עובד #2</MenuItem>
          </Select>
        </FormControl>
        ...
        <Table className={classes.table}>
          ...
          <TableFooter>
            ...
            <TableCell className={classes.cell} colSpan={4}>
              ...
              <TableCell className={classes.footerCell} numeric colSpan={3}>
                7
              </TableCell>
              <TableCell>
              </TableCell>
